                ...
                <form id="form-media-edit" class="grid gap-4 md:grid-cols-2" autocomplete="off">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                          ...
                          rows="5"
                          class="block w-full resize-none overflow-hidden rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:border-gray-500 dark:bg-gray-800 dark:text-white dark:focus:border-blue-400 dark:focus:ring-blue-900"
                          maxlength="1000"
                        ></textarea>
                    </div>
                    <div>
