...
>
    ...
    <h2 id="collapse-item-heading-media">
        <button 
          type="button" 
          class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
    ...
    <h2 id="collapse-item-heading-about">
        <button 
          type="button" 
          class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" 
    ...
    >
        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700 overflow-y-auto" style="max-height: calc(100vh - 420px);">
            <p class="mb-2 text-gray-500 dark:text-gray-400">
