<div
  ...
  class="relative w-full mt-4 flex justify-center"
...
>
    <button 
      ...
      disabled
    >
        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 group-hover:bg-blue-200/50 dark:group-hover:bg-blue-400 group-focus:outline-none">
            <svg class="w-4 h-4 text-gray-400 dark:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
