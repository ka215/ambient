<div 
  id="drawer-settings"
  class="fixed top-0 right-0 z-50 h-screen overflow-y-auto transition-transform translate-x-full bg-white w-80 dark:bg-gray-800"
  tabindex="-1"
  aria-labelledby="drawer-settings-label"
>
    <div class="p-4 fixed top-0 right-0 z-auto w-80 h-14 flex flex-nowrap justify-between items-center bg-white dark:bg-gray-800">
        <h5 id="drawer-settings-label" class="inline-flex items-center text-base font-semibold text-gray-500 dark:text-gray-400 text-rotate-0">
            <svg class="w-5 h-5 mr-2.5 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500 text-rotate-0" aria-hidden="true" aria-label="settings" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    ...
    <div 
      class="w-full mt-14 mb-16 overflow-y-auto text-sm font-normal text-gray-900 bg-white border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
