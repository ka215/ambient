...
>
    <div class="p-4 fixed top-0 right-0 z-auto w-80 h-14 flex flex-nowrap justify-between items-center bg-white border-r border-b dark:bg-gray-800 dark:border-gray-600">
        <h5 id="drawer-settings-label" class="inline-flex items-center text-base font-semibold text-gray-500 dark:text-white text-rotate-0">
            <span class="ui-icon-mask ui-icon-mask--settings w-5 h-5 mr-2.5 text-gray-500 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-500 text-rotate-0" aria-hidden="true" aria-label="settings"></span>
...
<?php endforeach; endif; ?>
        ...
        <div class="p-4">
            <label id="toggle-loop" class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" class="sr-only peer">
                <div class="toggle-track w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-600 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 relative overflow-hidden"></div>
                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300" disabled><?= __( 'Playback in a loop' ) ?></span>
            </label>
        </div>
        <div class="p-4">
        ...
        <div class="p-4">
            <label id="toggle-shuffle" class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" class="sr-only peer">
                <div class="toggle-track w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-600 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 relative overflow-hidden"></div>
                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300" disabled><?= __( 'Shuffle play' ) ?></span>
            </label>
        </div>
        <div class="p-4">
        ...
        <div class="p-4">
            <label id="toggle-window-full" class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" class="sr-only peer">
                <div class="toggle-track w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-600 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 relative overflow-hidden"></div>
                <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300" disabled><?= __( 'Expand to fill window' ) ?></span>
            </label>
        </div>
        <div class="p-4">
