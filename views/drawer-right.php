<div 
  id="drawer-settings"
  class="fixed top-0 right-0 z-50 h-screen overflow-y-auto transition-transform translate-x-full bg-white border-l border-gray-200 w-80 dark:bg-gray-800 dark:border-gray-600 dark:text-white shadow"
  tabindex="-1"
  aria-labelledby="drawer-settings-label"
>
    <div class="p-4 fixed top-0 right-0 z-auto w-80 h-14 flex flex-nowrap justify-between items-center bg-white border-r border-b dark:bg-gray-800">
