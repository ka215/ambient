...
const init = function () {
    ...
    function isPlaylistLoadActive(seq) {
        return activePlaylistLoadSeq === seq;
    }
    function beginPlaylistLoad(playlist) {
    ...
    function finishPlaylistLoad(seq) {
    ...
    function loadMyPlaylistFromStorage() {
        ...
        try {
            ...
            categories.forEach((category, cid) => {
                ...
                media = media.concat(items.map((item) => ({
                    ...item,
                    catId: cid,
                })));
            });
